...
RUN apt-get -y --no-install-recommends install \
 ...
 && /usr/bin/wget --user-agent="Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) HalloWelt/1.0" -O /opt/BlueSpice-free.zip https://bluespice.com/filebase/bluespice-free-3-2-4/
