...
if [ -f "/opt/docker/.firstrun" ]; then
    ...
    if ! [[ -d "/data/mysql" ]] && ! [[ -f "/data/www/bluespice/w/LocalSettings.php" ]]; then
        ...
        /usr/bin/php /data/www/bluespice/w/maintenance/runJobs.php --memory-limit=max --maxjobs=50 > /dev/null 2>&1
        ...
        cp -Rf "/data/www/$date/w/images" /data/www/bluespice/w/images  > /dev/null 2>&1
        mkdir -p /data/www/bluespice/w/extensions/BlueSpiceFoundation/data > /dev/null 2>&1
        mkdir -p /data/www/bluespice/w/extensions/BlueSpiceFoundation/config > /dev/null 2>&1
        cp -Rf /data/www/bluespice/w/extensions/BlueSpiceFoundation/config.template/* /data/www/bluespice/w/extensions/BlueSpiceFoundation/config/ > /dev/null 2>&1
        cp -Rf /data/www/bluespice/w/extensions/BlueSpiceFoundation/data.template/* /data/www/bluespice/w/extensions/BlueSpiceFoundation/data/ > /dev/null 2>&1
        cp -Rf "/data/www/$date/w/extensions/BlueSpiceFoundation/data/*" /data/www/bluespice/w/extensions/BlueSpiceFoundation/data/  > /dev/null 2>&1
        cp -Rf "/data/www/$date/w/extensions/BlueSpiceFoundation/config/*" /data/www/bluespice/w/extensions/BlueSpiceFoundation/config/  > /dev/null 2>&1
        cp -f "/data/www/$date/w/LocalSettings.php" /data/www/bluespice/w/  > /dev/null 2>&1
...
echo "."
/etc/init.d/parsoid restart > /dev/null 2>&1
echo ".."
/etc/init.d/mysql restart > /dev/null 2>&1
echo "..."
/etc/init.d/jetty9 restart > /dev/null 2>&1
echo "...."
